...
class MyCListView extends CBaseListView {
	/**
	...
	public function renderItems()
	{
		...
		if(count($data)>0)
		{
			...
			{
                $last=(isset($data[$i+1]))?false:true;
                $break =(($i)%4==0) ? true : false;
				$data1=$this->viewData;
				$data1['index']=$i;
                $data1['last']=$last;
                $data1['break']=$break;
				...
				$owner->$render($this->itemView,$data1);
			}
		}
		else
    	...
    	public function renderSummary()
	{
		...
		echo '<div class="'.$this->summaryCssClass.'"><div class="checkall"><input type="checkbox" id="check_all"> <span>все</span></div>';
